        ...
        this.innerHTML = `
            <div id="location-panel" class="location-panel">
                ...
                <div class="panel-actions">
                    ...
                    <!-- Save location (wired up by mapFunctions.js) -->
                    <button class="panel-btn panel-save-btn" disabled>
                        <svg class="bookmark-filled" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16" style="display:none">
                            <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5V2z"/>
                        </svg>
                        <svg class="bookmark-outline" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
